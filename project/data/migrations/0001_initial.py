# Generated by Django 2.0.4 on 2018-07-26 08:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(default=[], null=True, related_name='students_course', to=settings.AUTH_USER_MODEL)),
                ('teaching_assistants', models.ManyToManyField(default=[], null=True, related_name='teaching_assistants_course', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='HWFFile',
        ...
        migrations.AddField(
            ...
            name='addfile',
            field=models.ManyToManyField(related_name='assignment', to='data.HWFFile'),
        ),
        migrations.AddField(
            model_name='hwfassignment',
            name='course_class',
